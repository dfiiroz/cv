...
\leftheader{%
  {\LARGE\bfseries\sffamily Md. Firoz Hossain }
  \newline
  \makefield{\faEnvelope[regular]}{\href{mailto:imfirozhossain@gmail.com}{\texttt{imfirozhossain@gmail.com}}}
    \newline
  \makefield{\faLinkedin}
  {\href{http://www.linkedin.com/in/econfiroz/}{\texttt{econfiroz}}}

  %% Next line
  \makefield{\faPhone}{\texttt{(+880)1521-114889}}
